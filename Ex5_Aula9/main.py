...
Exercicio 5: Crie um software de gerenciamento bancário.
Esse software poderá ser capaz de criar clientes e contas.
Cada cliente possui nome, cpf, idade.
Cada conta possui um cliente, saldo, limite, sacar, depositar e
consultar saldo.
"""
...
conta_do_gui.depositar(1000)
print(conta_do_gui.consulta_saldo())
conta_do_gui.sacar(500)
print(conta_do_gui.consulta_saldo())
conta_do_gui.sacar(500000000000)
print(conta_do_gui.consulta_saldo())
